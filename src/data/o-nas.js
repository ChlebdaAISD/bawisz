export const ONAS_FAQ = [
  ...
  {
    q: 'Czy organizujecie urodziny, warsztaty i wyjścia grupowe?',
    a: 'Tak — w trzech formatach. Urodziny w pakiecie MINI (45 zł/os., 2 h) lub STANDARD (74 zł/os., 2,5 h, sala tylko dla was, min. 10 dzieci, prezent dla solenizanta). Warsztaty — sensoplastyka, plastyka, zajęcia kreatywne w duchu Montessori. Wyjścia grupowe dla przedszkoli i szkół od 15 zł za dziecko (min. 10 osób, kawa lub herbata gratis dla 1 opiekuna na 5 dzieci). Detale na osobnych podstronach.',
  },
  {
    q: 'Jak najszybciej zarezerwować termin albo zapytać o szczegóły?',
    a: 'Telefon lub SMS na +48 693 766 049 — odpisujemy w godzinach otwarcia. Można też napisać na Instagramie (@bawisz_bawialnia) albo na Facebooku. Wstęp do bawialni jest bez rezerwacji — wchodzisz, kupujesz bilet przy ladzie. Urodziny, warsztaty i grupy zorganizowane wymagają wcześniejszego ustalenia daty.',
  },
]
