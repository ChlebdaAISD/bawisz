export const HOME_FAQ = [
  {
    q: 'Ile kosztuje wstęp do bawialni w Nowym Targu?',
    a: '1 godzina to 25 zł, 1,5 h — 29 zł, 2 h — 33 zł, a cały dzień (NO LIMIT) — 45 zł. Karnet miesięczny NO LIMIT (cały miesiąc kalendarzowy) kosztuje 215 zł. Opiekun zawsze gratis, drugie i każde kolejne dziecko z rodzeństwa ma 25% zniżki.',
  },
  {
    q: 'Dla jakiego wieku jest bawialnia Bawisz?',
    a: 'Sala jest przemyślana dla dzieci od 0 do 10 lat. Drewniana przestrzeń w duchu Montessori dzieli się na strefy dopasowane do wieku — niemowlę, dwulatek i ośmiolatek znajdą u nas coś dla siebie.',
  },
  {
  ...
  },
  {
    ...
    a: 'Tak — drugie i każde kolejne dziecko z rodzeństwa ma 25% zniżki na każdy pakiet czasowy. Opiekun (rodzic, dziadek, babcia) zawsze wchodzi gratis. Mamy też karty podarunkowe od 29 zł — popularny prezent na chrzciny i pierwsze urodziny.',
  },
]
...
export const HOME_META = {
  ...
  ogImage: 'https://bawialniabawisz.pl/assets/zdjecia/strona_glowna/Bawisz_-13.webp',
}
